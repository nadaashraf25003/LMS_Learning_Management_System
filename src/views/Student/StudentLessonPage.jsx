              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`text-sm font-bold min-w-12 transition-all duration-700 ${
              ...
              {lesson.videoUrl && (
                <div className="card p-2 card-hover border border-border">
                  ...
                  <div className="p-4 text-sm text-text-secondary flex items-center justify-between">
                    <span>
                      Click the complete button above to mark this lesson as
                      finished
                    </span>
                    ...
                    {lesson.quizzes.map((quiz, index) => (
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <svg
                            className="w-5 h-5 text-text-secondary group-hover:text-secondary transition-colors duration-200"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
