      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              {pendingBalance > 0 && (
                <button
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-sm hover:shadow flex items-center gap-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Pending Balance</p>
                <p className="text-3xl font-bold text-yellow-600 mt-2">{formatCurrency(pendingBalance)}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Completed Payouts</p>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900 font-medium rounded-lg hover:bg-gray-100 transition-colors"
                  >
                    Export Report
                  </button>
                </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">70% of total earnings</p>
                          </div>
                        </div>
                        <span className="font-bold text-gray-900">{formatCurrency(totalEarnings * 0.7)}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">20% of total earnings</p>
                          </div>
                        </div>
                        <span className="font-bold text-gray-900">{formatCurrency(totalEarnings * 0.2)}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-gray-900">Other Sources</p>
                            <p className="text-sm text-gray-600">10% of total earnings</p>
                          </div>
                        </div>
                        <span className="font-bold text-gray-900">{formatCurrency(totalEarnings * 0.1)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Payouts are processed twice monthly</p>
                          </div>
                          <div className="text-right">
                            <p className="font-bold text-blue-600">January 1, 2025</p>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Minimum Payout Threshold</span>
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium text-gray-green">3-5 business days</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    {pendingBalance > 0 && (
                      <div className="mt-6 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-bold text-gray-900">Ready to Withdraw</p>
                            <p className="text-2xl font-bold text-yellow-600 mt-1">{formatCurrency(pendingBalance)}</p>
                            <p className="text-sm text-gray-600 mt-1">Available for immediate payout</p>
                          </div>
                          <button
                            className="px-6 py-2.5 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-medium rounded-lg hover:from-yellow-600 hover:to-orange-600 transition-all"
                            onClick={handleRequestPayout}
                          >
                            Request Payout
                          </button>
            ...
            {currentTab === "requests" && (
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  {pendingBalance > 0 && (
                    <button
                      className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all"
                      onClick={handleRequestPayout}
                    >
                      New Payout Request
                    </button>
                ...
                {payments.filter(p => p.type === "payout").length > 0 ? (
                  <div className="grid gap-4">
                    {payments
                      .filter(p => p.type === "payout")
                      .map((request) => (
                        <div key={request.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition-shadow">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">Requested on {formatDate(request.date)}</p>
                              </div>
                            </div>
                          ...
                          {request.status === "pending" && (
                            <div className="mt-4 pt-4 border-t border-gray-200">
                              <div className="flex items-center justify-between">
                                <p className="text-sm text-gray-600">Estimated processing time: 3-5 business days</p>
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">You haven't made any payout requests yet.</p>
                    {pendingBalance > 0 && (
                      <button
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-600">Tax Information</p>
                    <p className="font-medium text-gray-900 mt-2">W-9 Form Submitted</p>
                    <p className="text-sm text-gray-600">Tax rate: 10%</p>
                  </div>
                </div>
                
                <div className="space-y-4">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Payout Threshold</p>
                    <p className="text-2xl font-bold text-gray-900 mt-2">$50.00</p>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 mt-2">{formatDate(payments.find(p => p.type === "payout" && p.status === "completed")?.date) || "N/A"}</p>
                    <p className="text-sm text-gray-600">View all payouts in History</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {pendingBalance > 0 && (
                  <button
                    className="w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all"
                    onClick={handleRequestPayout}
                  >
                    Request Payout
                  </button>
